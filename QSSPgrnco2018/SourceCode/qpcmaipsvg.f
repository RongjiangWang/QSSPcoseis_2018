      subroutine qpcmaipsvg(ly,ldeg,rr,mat)
      use qpcalloc
      implicit none
...
c
      ...
      mat(2,3)=dll1*(rhorr*grrr
     &        -2.d0*muerr*(1.d0+2.d0*lamrr/ksirr)/rr)/rr
      mat(2,4)=dll1/rr
...
c
      ...
      mat(3,6)=0.d0
c
      mat(4,1)=rhorr*grrr/rr-2.d0*muerr*(1.d0+2.d0*lamrr/ksirr)/rr**2
