      subroutine qpcmaipsv(ly,ldeg,rr,mat)
      use qpcalloc
      implicit none
      integer*4 ly,ldeg
      real*8 rr
...
c
      ...
      mat(1,6)=0.d0
c
      mat(2,1)=4.d0*muerr*(1.d0+2.d0*lamrr/ksirr)/rr**2
      mat(2,2)=-4.d0*muerr/ksirr/rr
      mat(2,3)=-2.d0*dll1*muerr*(1.d0+2.d0*lamrr/ksirr)/rr**2
      mat(2,4)=dll1/rr
      mat(2,5)=0.d0
      mat(2,6)=0.d0
c
      ...
      mat(3,6)=0.d0
c
      mat(4,1)=-2.d0*muerr*(1.d0+2.d0*lamrr/ksirr)/rr**2
      mat(4,2)=-lamrr/ksirr/rr
      mat(4,3)=2.d0*muerr*(2.d0*dll1*(1.d0-muerr/ksirr)-1.d0)/rr**2
      mat(4,4)=-3.d0/rr
      mat(4,5)=0.d0
      mat(4,6)=0.d0
c
